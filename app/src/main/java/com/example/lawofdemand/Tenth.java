...
public class Tenth extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.traffic_page);
...
break;
	...
	case R.id.btnaaddevidence:
		Intent evidence = new Intent(Tenth.this,Eleventh.class);
